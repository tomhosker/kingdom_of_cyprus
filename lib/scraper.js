...
class KingdomScraper {
    ...
    fetchDuchies(req, res) {
        var query =
            "SELECT Duchy.code AS code, Duchy.name AS name, " +
            "Duchy.duke AS duke, " +
...
class ChivalricScraper {
    ...
    fetchHolds(req, res, code, data) {
        var query =
            "SELECT Holds.person, Holds.accolade, Person.code, " +
...
class AcademyScraper {
    ...
    fetchLeadership(req, res, data) {
        var query =
            "SELECT AcademyProperty.*, Person.code AS personCode, " +
...
class FacultyScraper {
    ...
    fetchFaculty(req, res) {
        var query =
            "SELECT Faculty.*, Person.code AS personCode, " +
...
class FacultyDepartmentScraper {
    ...
    getBook(data, req, res) {
        var query =
            "SELECT Book.*, Author.shortTitle AS authorShortTitle " +
            "FROM Book " +
...
class HLibraryScraper {
    ...
    fetchGoldenPoets(req, res) {
        var query =
            "SELECT Book.*, Author.fullTitle AS authorFullTitle " +
...
class HCatalogueScraper {
    ...
    fetchGreek(req, res, data) {
        var query =
            "SELECT PaperBook.*, Author.fullTitle AS authorFullTitle " +
            "FROM PaperBook " +
            "LEFT JOIN Author ON Author.code = PaperBook.author " +
...
class HCinemaScraper {
    ...
    fetchAdaptations(req, res, data) {
        var query =
            "SELECT Film.title, Film.year, Film.notes, " +
