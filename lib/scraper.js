...
class Scraper
{
  ...
  scrapeAsIs(req, res)
  {
    ...
    var page = new AsIsScraper();

    page.checkTableName(req, res, tableName);
  }
  ...
  {
    var code = req.params.id;
    var page = new ChivalricScraper();

    page.fetchChivalric(req, res, code);
  }
}
...
class ChivalricScraper
{
  ...
  fetchChivalric(req, res, code)
  {
    var query = "SELECT Chivalric.*, "+
                       ...
                       "Master.rankTier AS masterRankTier "+
                "FROM Chivalric "+
                "JOIN Person Master on Master.code = Chivalric.master "+
...
/*
    var query = "SELECT Holds.person, Holds.accolade, Person.code, "+
                ...
                "JOIN Accolade ON Accolade.name = Holds.accolade "+
