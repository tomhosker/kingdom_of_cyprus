...
const currentMonarchCode = "T", currentMonarchHebrewYearDiff = 5774;
...
class SacredDate
{
    ...
    buildSeason()
    {
        ...
        {
            result = new Lent(this.gregorian, this.ashWednesday,
                              this.easter);
        }
        else if(this.seasonal === "Easter")
        {
            result = new Easter(this.gregorian, this.easter,
                                this.pentecost);
        }
...
class Advent
{
    ...
    buildWeek()
    {
        ...
        var daysAfterAdventSunday = SacredDate.daysAfter(
                                        this.adventSunday, today,
                                        this.gregorian.year);
        var weekNo = daysAfterAdventSunday-
                     daysAfterAdventSunday%daysInAWeek;
...
class Christmas
{
    ...
    {
        var today = [this.gregorian.day, this.gregorian.month];
        var result = SacredDate.nToNth(this.dayOfChristmas)+
                     " day of Christmas";
...
class Easter
{
    ...
    buildDateString()
    {
        ...
        else if(SacredDate.fallsOn(this.ascension, today,
                                   this.gregorian.year))
        {
            result = "The Feast of the Ascension";
        }
        else if(SacredDate.fallsOn(this.pentecost, today,
                                   this.gregorian.year))
        {
