...
class CountyMaker
{
  ...
  getComes()
  {
    var result = utils.makePersonLink(this.data.County.comesShortTitle,
                                      this.data.County.comes,
                                      this.data.County.comesStyle,
                                      this.data.County.comesRankTier);
