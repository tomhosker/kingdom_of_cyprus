...
class FacultyDepartmentMaker
{
  ...
  getProfessor()
  {
    ...
    {
      result =
        utils.makePersonLink(this.data.department[0].personShortTitle,
  ...
  getFaculty()
  {
    ...
    {
      result = "<a href=\"/academy/faculty/"+
               this.data.department[0].facultyCode+"\">"+
               this.data.department[0].facultyName+"</a>";
    }
...
function getTheologyLibrary(table)
{
  var result = {};
  var sacredLanguages = {};
  var hebrew = [], greek = [], latin = [], translations = [];
  var generalTheology = [];
