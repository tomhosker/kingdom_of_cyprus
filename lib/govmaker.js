...
class GovMaker {
    constructor(data) {
        ...
        this.chancellor = getOfficer(
            data.chancellorShortTitle,
            data.chancellor,
            data.chancellorStyle,
            data.chancellorRankTier
        );
        this.marshal = getOfficer(
            data.marshalShortTitle,
            data.marshal,
            data.marshalStyle,
            data.marshalRankTier
        );
        this.steward = getOfficer(
            data.stewardShortTitle,
            data.steward,
            data.stewardStyle,
            data.stewardRankTier
        );
        this.remembrancer = getOfficer(
            data.remembrancerShortTitle,
            data.remembrancer,
            data.remembrancerStyle,
            data.remembrancerRankTier
        );
        this.ecclesiarch = getOfficer(
            data.ecclesiarchShortTitle,
            data.ecclesiarch,
            data.ecclesiarchStyle,
            data.ecclesiarchRankTier
        );
        this.masterOfOffices = getOfficer(
            data.masterOfOfficesShortTitle,
            data.masterOfOffices,
            data.masterOfOfficesStyle,
            data.masterOfOfficesRankTier
        );
        this.masterOfHorse = getOfficer(
            data.masterOfHorseShortTitle,
            data.masterOfHorse,
            data.masterOfHorseStyle,
            data.masterOfHorseRankTier
        );
        this.masterOfTheRolls = getOfficer(
            data.masterOfTheRollsShortTitle,
        ...
        this.masterOfAlms = getOfficer(
            data.masterOfAlmsShortTitle,
            data.masterOfAlms,
            data.masterOfAlmsStyle,
            data.masterOfAlmsRankTier
        );
        this.regent = getOfficer(
            data.regentShortTitle,
            data.regent,
            data.regentStyle,
            data.regentRankTier
        );
